  ...
  (function (t) {
    ...
    for (o in ((s.fn.init = function (e) {
      ...
      return (
        'string' == typeof e &&
          '#' === e &&
          (u("jQuery( '#' ) is not a valid selector"),
          (t[0] = [])),
        c.apply(this, t)
      );
    }),
    ...
    if (
      ...
      s.param = function (e, t) {
        var r =
          s.ajaxSettings && s.ajaxSettings.traditional;
        return (
          void 0 === t &&
            r &&
            (u(
