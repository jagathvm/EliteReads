  ...
  $.fn.theiaStickySidebar = function (options) {
    ...
    function init(options, $that) {
      ...
      $that.each(function () {
        ...
        o.sidebar
          .parents()
          .css('-webkit-transform', 'none'); // Fix for WebKit bug - https://code.google.com/p/chromium/issues/detail?id=20574
        o.sidebar.css({
        ...
        o.stickySidebar = o.sidebar.find(
          '.theiaStickySidebar'
        );
        ...
        var collapsedTopHeight =
          o.stickySidebar.offset().top;
        var collapsedBottomHeight =
        ...
        o.onScroll = function (o) {
          ...
          if (
            ...
            var top =
              o.stickySidebar.offset().top - scrollTop;
            var scrollTopDiff =
              o.previousScrollTop - scrollTop;

            // If the sidebar position is fixed, then it won't move up or down by itself. So, we manually adjust the top coordinate.
            if (
              o.stickySidebar.css('position') == 'fixed'
            ) {
            ...
            if (
              o.options.sidebarBehavior == 'stick-to-top'
            ) {
              top = options.additionalMarginTop;
            }

            if (
              o.options.sidebarBehavior == 'stick-to-bottom'
            ) {
              top =
                windowOffsetBottom -
                o.stickySidebar.outerHeight();
          ...
          if (position == 'fixed') {
            ...
            o.stickySidebar.css({
              position: 'fixed',
              width:
                getWidthForObject(o.stickySidebar) + 'px',
            ...
            if (
              o.stickySidebar.css('position') != 'absolute'
            ) {
