...
!(function (i, e) {
  ...
  var m = 'day',
    ...
    c = {
      ...
      _render: function () {
        for (
          ...
          var d = i.clone();
          d.addClass(
            'syotimer-cell_type_' + t.itemTypes[s]
          ),
            o.append(d),
            (a[t.itemTypes[s]] = d);
        }
      ...
      _perSecondHandler: function () {
        var e = l(this),
          t = e.data('syotimer-options');
        l('.syotimer-cell > .syotimer-cell__value', e).css(
          'opacity',
          1
        );
        var i = new Date(),
        ...
        0 <= r
          ? (c._refreshUnitsDom.apply(this, [r]),
            c._applyEffectSwitch.apply(this, [
              t.effectType,
            ]))
          : ((e = l.extend(e, e.data('syotimer-blocks'))),
            t.afterDeadline(e));
      },
        ...
        'none' === e
          ...
          : 'opacity' !== e ||
            ((i = a.data('syotimer-items')[t]) &&
              ...
              n &&
                0 === o &&
                c._applyEffectSwitch.apply(r, [e, n])));
      },
    },
    y = {
        ...
        var i,
          ...
          s = t.periodic
            ? ((r =
                e /
                (1e3 *
                  (o = y.getPeriodUnit(t.periodUnit)))),
              (r = Math.ceil(r)),
              (r = Math.abs(r)),
              0 <= a
                ? ((n =
                    0 === (n = r % t.periodInterval)
                      ? t.periodInterval
                      : n),
                  --n)
                : (n =
    ...
    i = {
      setOption: function (e, t) {
        ...
        n.hasOwnProperty(e) &&
          ((n[e] = t), i.data('syotimer-options', n));
      },
    };
  (l.fn.syotimer = function (e) {
    ...
    if (null == e || 'object' == typeof e)
      return c.init.apply(this, [e]);
    l.error(
      'SyoTimer. Error in call methods: methods is not exist'
    );
  }),
    (l.syotimerLang = {
      rus: {
      ...
      getNumeral: function (e, t, i) {
        var n =
          this[l.syotimerLang[t].handler || 'universal'](e);
