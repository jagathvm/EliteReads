...
(function (t) {
  ...
  function s() {
    (this._curInst = null),
      ...
      (this.regional.en = t.extend(
        !0,
        {},
        this.regional['']
      )),
      (this.regional['en-US'] = t.extend(
        !0,
        {},
        this.regional.en
      )),
  ...
  (t.cleanData = (function (e) {
    ...
    (t.widget = function (e, i, s) {
      ...
      return (
        s || ((s = i), (i = t.Widget)),
        t.isArray(s) &&
          (s = t.extend.apply(null, [{}].concat(s))),
    ...
    (t.Widget.prototype = {
      ...
      option: function (e, i) {
        ...
        if ('string' == typeof e)
          if (
            ...
            for (
              n = a[e] =
                t.widget.extend({}, this.options[e]),
                o = 0;
              s.length - 1 > o;
              o++
            )
      ...
      _toggleClass: function (t, e, i, s) {
        ...
        return (
          o.element.toggleClass(this._classes(o), s), this
        );
      },
      _on: function (e, i, s) {
        var n,
    ...
    (function () {
      ...
      (t.position = {
          ...
          return (
            ...
            this.each(function () {
              var s,
                ...
                _ = i(this, 'marginTop'),
                x =
                  l + d + i(this, 'marginRight') + y.width,
                C =
                  c +
                  _ +
                  i(this, 'marginBottom') +
        ...
        (t.ui.position = {
          ...
          flipfit: {
            left: function () {
              t.ui.position.flip.left.apply(
                this,
                arguments
              ),
                t.ui.position.fit.left.apply(
                  this,
                  arguments
                );
            },
  ...
  (t.effects = { effect: {} }),
    (function (t, e) {
      ...
      (p.style.cssText = 'background-color:rgba(1,1,1,.5)'),
        (d.rgba =
          p.style.backgroundColor.indexOf('rgba') > -1),
        f(c, function (t, e) {
          (e.cache = '_' + t),
            (e.props.alpha = {
              idx: 3,
      ...
      t.expr &&
        ...
        t.fn.extend({
          ...
          show: (function (t) {
            return function (s) {
              ...
              return (
                (n.mode = 'show'), this.effect.call(this, n)
              );
            };
          })(t.fn.show),
          hide: (function (t) {
            return function (s) {
              ...
              var n = e.apply(this, arguments);
              return (
                (n.mode = 'hide'), this.effect.call(this, n)
              );
            };
          })(t.fn.hide),
          toggle: (function (t) {
        ...
        (t.fx.step.clip = function (e) {
          e.clipInit ||
            ...
            'string' == typeof e.end &&
              (e.end = s(e.end, e.elem)),
            (e.clipInit = !0)),
            t(e.elem).cssClip({
              top:
                e.pos * (e.end.top - e.start.top) +
                e.start.top,
              right:
  ...
  t.effects.define('blind', 'hide', function (e, i) {
    ...
    t.effects.define('drop', 'hide', function (e, i) {
      ...
      t.effects.createPlaceholder(n),
        (s =
          e.distance ||
          n['top' === h ? 'outerHeight' : 'outerWidth'](
            !0
          ) / 2),
        (u[h] = l + s),
        ...
        s
          .queue(function (i) {
            d &&
              d
                .animate(
                  t.effects.clipToBox(f),
                  u,
                  e.easing
                )
                .animate(
                  t.effects.clipToBox(g),
                  u,
                  e.easing
                ),
              i();
    ...
    t.effects.define('size', function (e, i) {
      ...
      t.effects.createPlaceholder(a),
        ...
        p &&
          ...
          (_.top =
            (m.outerHeight - _.outerHeight) * s.y + g.top),
          (_.left =
            (m.outerWidth - _.outerWidth) * s.x + g.left),
          (v.top =
            (m.outerHeight - v.outerHeight) * s.y + g.top),
          (v.left =
  ...
  t.uiBackCompat !== !1 &&
    ...
    t.extend(t.expr[':'], {
      focusable: function (e) {
        return t.ui.focusable(
          e,
          null != t.attr(e, 'tabindex')
        );
      },
    }),
    t.ui.focusable,
    ...
    (t.ui.safeActiveElement = function (t) {
      ...
      return (
        e || (e = t.body), e.nodeName || (e = t.body), e
      );
    }),
    t.widget('ui.menu', {
      version: '1.12.1',
      ...
      _scrollIntoView: function (e) {
        ...
        this._hasScroll() &&
          ...
          (s =
            parseFloat(
              t.css(this.activeMenu[0], 'paddingTop')
            ) || 0),
          (n =
            e.offset().top -
        ...
        this.active &&
          (s =
            'first' === t || 'last' === t
              ...
              : this.active[t + 'All']('.ui-menu-item').eq(
                  0
                )),
      ...
      select: function (e) {
        this.active =
          this.active ||
          t(e.target).closest('.ui-menu-item');
    ...
    t.widget('ui.autocomplete', {
      ...
      _create: function () {
        ...
        (this.isMultiLine =
          o ||
          (!a && this._isContentEditable(this.element))),
          (this.valueMethod =
            this.element[o || a ? 'val' : 'text']),
          (this.isNewMenu = !0),
              ...
              return this.isNewMenu &&
                ...
                : ((n = i.item.data(
                  ...
                  !1 !==
                    ...
                    this._value(n.value),
                  (s =
                    i.item.attr('aria-label') || n.value),
                  s &&
                    t.trim(s).length &&
    ...
    t.extend(t.ui.autocomplete, {
      ...
      filter: function (e, i) {
        var s = RegExp(
          t.ui.autocomplete.escapeRegex(i),
          'i'
        );
  ...
  t.widget('ui.controlgroup', {
    ...
    _updateCornerClass: function (t, e) {
      var i =
        ...
        s = this._buildSimpleOptions(e, 'label').classes
          .label;
    ...
    t.widget('ui.button', {
      ...
      _attachIconSpace: function (t) {
        this.icon[
          /^(?:end|bottom)/.test(t) ? 'before' : 'after'
        ](this.iconSpace);
      },
      _attachIcon: function (t) {
        this.element[
          /^(?:end|bottom)/.test(t) ? 'append' : 'prepend'
        ](this.icon);
      },
      _setOptions: function (t) {
        var e =
            void 0 === t.showLabel
              ...
              : t.showLabel,
          i =
            void 0 === t.icon ? this.options.icon : t.icon;
  ...
  t.extend(s.prototype, {
      ...
      r.length > 0 && o.apply(r.get(0)),
        ...
        n > 1 &&
          e.dpDiv
            ...
            .css('width', a * n + 'em'),
        e.dpDiv[
          (1 !== s[0] || 1 !== s[1] ? 'add' : 'remove') +
            'Class'
        ]('ui-datepicker-multi'),
        e.dpDiv[
          (this._get(e, 'isRTL') ? 'add' : 'remove') +
            'Class'
        ]('ui-datepicker-rtl'),
    ...
    parseDate: function (e, i, s) {
      ...
      if (
        i.length > h &&
        ((a = i.substr(h)), !/^\s+/.test(a))
      )
        throw (
          'Extra/unparsed characters found in date: ' + a
        );
      if (
        (-1 === g
        ...
        for (m = 1, _ = v; ; ) {
          if (
            ((o = this._getDaysInMonth(g, m - 1)), o >= _)
          )
            break;
          m++, (_ -= o);
        }
      ...
      e.dpDiv.find('[data-handler]').map(function () {
        var e = {
          ...
          selectMonth: function () {
            return (
              t.datepicker._selectMonthYear(s, this, 'M'),
              !1
            );
          },
          selectYear: function () {
            return (
              t.datepicker._selectMonthYear(s, this, 'Y'),
              !1
            );
          },
        };
        ...
        ? 'option' === e &&
          ...
          : this.each(function () {
              'string' == typeof e
                ? t.datepicker[
                    '_' + e + 'Datepicker'
                  ].apply(t.datepicker, [this].concat(i))
  ...
  t(document).on('mouseup', function () {
    ...
    t.widget('ui.draggable', t.ui.mouse, {
      ...
      _mouseCapture: function (e) {
        ...
        return this.helper ||
          i.disabled ||
          t(e.target).closest('.ui-resizable-handle')
            .length > 0
          ? !1
      ...
      _cacheMargins: function () {
        this.margins = {
          left:
            ...
            0,
          top:
            parseInt(this.element.css('marginTop'), 10) ||
            0,
          right:
            parseInt(this.element.css('marginRight'), 10) ||
            0,
          bottom:
            parseInt(
    ...
    t.widget('ui.resizable', t.ui.mouse, {
      ...
      _mouseStart: function (e) {
        ...
        return (
          ...
          (n = t('.ui-resizable-' + this.axis).css(
            'cursor'
          )),
          t('body').css(
            'cursor',
      ...
      _mouseStop: function (e) {
        ...
        return (
          this._helper &&
            ...
            (s =
              i.length && /textarea/i.test(i[0].nodeName)),
            (n =
      ...
      _updateCache: function (t) {
        (this.offset = this.helper.offset()),
          this._isNumber(t.left) &&
            (this.position.left = t.left),
          this._isNumber(t.top) &&
          ...
          for (
            ...
            (t = this._proportionallyResizeElements[e]),
              ...
              t.css({
                ...
                width:
                  i.width() - this.outerDimensions.width ||
                  0,
              });
      },
      ...
      resize: function () {
        ...
        (s.grid = h),
          ...
          /^(se|s|e)$/.test(r)
            ...
            : ((0 >= f - c || 0 >= p - l) &&
                (e =
                  i._getPaddingPlusBorderDimensions(this)),
              f - c > 0
                ? ((i.size.height = f),
                  (i.position.top = a.top - d))
                : ((f = c - e.height),
    ...
    t.widget('ui.dialog', {
      ...
      close: function (e) {
        ...
        this._isOpen &&
          ...
          this._destroyOverlay(),
          this._untrackInstance(),
          this.opener.filter(':focusable').trigger('focus')
            .length ||
            t.ui.safeBlur(
              t.ui.safeActiveElement(this.document[0])
            ),
      ...
      _focusTabbable: function () {
        ...
        t || (t = this.element.find('[autofocus]')),
          ...
          t.length ||
            (t =
              this.uiDialogTitlebarClose.filter(
                ':tabbable'
              )),
        ...
        return (
          ...
          t.isEmptyObject(i) || (t.isArray(i) && !i.length)
            ...
            : (t.each(i, function (i, s) {
              ...
              this.uiDialogButtonPane.appendTo(
                this.uiDialog
              ),
              void 0)
        );
    ...
    t.widget('ui.droppable', {
      ...
      _destroy: function () {
        var e =
          t.ui.ddmanager.droppables[this.options.scope];
        this._splice(e);
      },
      _setOption: function (e, i) {
        if ('accept' === e)
  ...
  (t.ui.ddmanager = {
    ...
    t.widget('ui.selectable', t.ui.mouse, {
      ...
      _mouseStop: function (e) {
        ...
        return (
          (this.dragged = !1),
          t('.ui-unselecting', this.element[0]).each(
            function () {
              var s = t.data(this, 'selectable-item');
          ...
          t('.ui-selecting', this.element[0]).each(
            function () {
              var s = t.data(this, 'selectable-item');
              i
    ...
    t.widget('ui.selectmenu', [
      t.ui.formResetMixin,
      {
        ...
        _getCreateOptions: function () {
          var t = this._super();
          return (
            (t.disabled = this.element.prop('disabled')), t
          );
        },
        ...
        _parseOption: function (t, e) {
          ...
          return {
            ...
            disabled:
              i.prop('disabled') || t.prop('disabled'),
          };
        },
        _destroy: function () {
          this._unbindFormResetHandler(),
    ...
    t.widget('ui.slider', t.ui.mouse, {
      ...
      _createHandles: function () {
        ...
        for (
          ...
          a.push(o);
        (this.handles = n.add(
          t(a.join('')).appendTo(this.element)
        )),
          this._addClass(
            this.handles,
            'ui-slider-handle',
    ...
    t.widget('ui.sortable', t.ui.mouse, {
      ...
      _mouseStart: function (e, i, s) {
        ...
        if (
          ...
          (this.originalPageY = e.pageY),
          a.cursorAt &&
            this._adjustOffsetFromHelper(a.cursorAt),
          (this.domPosition = {
      ...
      cancel: function () {
        if (this.dragging) {
          this._mouseUp(
            new t.Event('mouseup', { target: null })
          ),
            'original' === this.options.helper
      ...
      _createPlaceholder: function (e) {
        ...
        var i,
          s = e.options;
        (s.placeholder &&
          s.placeholder.constructor !== String) ||
          ((i = s.placeholder),
          (s.placeholder = {
            element: function () {
              var s =
                  e.currentItem[0].nodeName.toLowerCase(),
                n = t('<' + s + '>', e.document[0]);
              return (
                e
                  ._addClass(
      ...
      _cacheMargins: function () {
        this.margins = {
          left:
            parseInt(
              this.currentItem.css('marginLeft'),
              10
            ) || 0,
          top:
            parseInt(
              this.currentItem.css('marginTop'),
              10
            ) || 0,
        };
      },
        ...
        'parent' === n.containment &&
          ...
          /^(document|window|parent)$/.test(
            ...
            (this.containment = [
              i.left +
                (parseInt(
                  t(e).css('borderLeftWidth'),
                  10
                ) || 0) +
                (parseInt(t(e).css('paddingLeft'), 10) ||
                  0) -
                this.margins.left,
              i.top +
                (parseInt(t(e).css('borderTopWidth'), 10) ||
                  0) +
                (parseInt(t(e).css('paddingTop'), 10) ||
                  0) -
                this.margins.top,
              i.left +
                (s
                ...
                (parseInt(t(e).css('paddingRight'), 10) ||
                  0) -
                this.helperProportions.width -
                this.margins.left,
              i.top +
                ...
                (parseInt(t(e).css('borderTopWidth'), 10) ||
                  0) -
                (parseInt(t(e).css('paddingBottom'), 10) ||
                  0) -
                this.helperProportions.height -
                this.margins.top,
            ]));
      ...
      _clear: function (t, e) {
        ...
        for (
          ...
          e ||
            n.push(
              i('deactivate', this, this.containers[s])
            ),
    ...
    t.widget('ui.spinner', {
      ...
      _events: {
        ...
        'mouseenter .ui-spinner-button': function (e) {
          return t(e.currentTarget).hasClass(
            'ui-state-active'
          )
            ? this._start(e) === !1
              ? !1
    ...
    t.widget('ui.tabs', {
      ...
      _handlePageNav: function (e) {
        return e.altKey &&
          e.keyCode === t.ui.keyCode.PAGE_UP
          ? (this._activate(
              this._focusNextTab(
                this.options.active - 1,
                !1
    ...
    t.widget('ui.tooltip', {
      ...
      _addDescribedBy: function (e, i) {
        var s = (e.attr('aria-describedby') || '').split(
          /\s+/
        );
        s.push(i),
          e
      ...
      _removeDescribedBy: function (e) {
        var i = e.data('ui-tooltip-id'),
          s = (e.attr('aria-describedby') || '').split(
            /\s+/
          ),
          n = t.inArray(i, s);
        -1 !== n && s.splice(n, 1),
        ...
        if (s) {
          ...
          i.is('[title]') &&
            ...
            this.options.track && e && /^mouse/.test(e.type)
              ? (this._on(this.document, { mousemove: n }),
                n(e))
              : a.position(
