  ...
  ((e = (function () {
    ...
    (e.prototype.cleanUpRows = function () {
      var i,
        e = this;
      e.options.rows > 1 &&
        ((i = e.$slides.children().children()).removeAttr(
          'style'
        ),
    ...
    (e.prototype.getCurrent =
      e.prototype.slickCurrentSlide =
        function () {
      ...
      if (
        ...
        if (
          ...
          !1 === a.options.infinite &&
            ...
            (i < 0 ||
              i >
                a.getDotCount() * a.options.slidesToScroll))
        )
          !1 === a.options.fade &&
            ((o = a.currentSlide),
            !0 !== t
          ...
          (i < 0 ||
            i > a.slideCount - a.options.slidesToScroll)
        )
          !1 === a.options.fade &&
            ((o = a.currentSlide),
            !0 !== t
    ...
    (e.prototype.swipeEnd = function (i) {
      var e,
        ...
        o = this;
      if (
        ((o.dragging = !1), (o.swiping = !1), o.scrolling)
      )
    ...
    (e.prototype.unfilterSlides =
      e.prototype.slickUnfilter =
        function () {
          var i = this;
          null !== i.$slidesCache &&
            (i.unload(),
