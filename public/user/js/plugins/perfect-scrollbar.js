...
(function (global, factory) {
  ...
  EventElement.prototype.unbind = function unbind(
    ...
    this.handlers[eventName] = this.handlers[
      eventName
  ...
  EventManager.prototype.eventElement =
  ...
  function processScrollDiff$1(
    ...
    if (
      element[scrollTop] >
      i[contentHeight] - i[containerHeight] - 1
    ) {
      i.reach[y] = 'end';
    }
    ...
    if (diff) {
      ...
      if (diff < 0) {
        element.dispatchEvent(
          createEvent('ps-scroll-' + up)
        );
      } else if (diff > 0) {
        element.dispatchEvent(
          createEvent('ps-scroll-' + down)
        );
      }
  ...
  function updateGeometry(i) {
    ...
    if (
      ...
      i.scrollbarXWidth = getThumbSize(
        i,
        toInt(
          (i.railXWidth * i.containerWidth) / i.contentWidth
        )
      );
  ...
  function updateCss(element, i) {
    ...
    if (i.isScrollbarXUsingBottom) {
      xRailOffset.bottom =
        i.scrollbarXBottom - roundedScrollTop;
    } else {
  ...
  function clickRail(i) {
    ...
    i.event.bind(
      ...
      function (e) {
        ...
        var direction =
          positionTop > i.scrollbarYTop ? 1 : -1;
    ...
    i.event.bind(
      ...
      function (e) {
        ...
        var direction =
          positionLeft > i.scrollbarXLeft ? 1 : -1;

        i.element.scrollLeft +=
  ...
  function bindMouseScrollHandler(i, ref) {
    ...
    function mouseMoveHandler(e) {
      ...
      element[scrollTop] =
        startingScrollTop +
        scrollBy * (e[pageY] - startingMousePageY);
    ...
    function mouseUpHandler() {
      ...
      i[scrollbarYRail].classList.remove(
        cls.state.clicking
      );
      i.event.unbind(
        i.ownerDocument,
  ...
  function wheel(i) {
    ...
    function shouldBeConsumedByChild(
      ...
      while (cursor && cursor !== element) {
        ...
        if (
          deltaY &&
          style.overflowY.match(/(scroll|auto)/)
        ) {
          var maxScrollTop =
        ...
        if (
          deltaX &&
          style.overflowX.match(/(scroll|auto)/)
        ) {
          var maxScrollLeft =
          ...
          if (maxScrollLeft > 0) {
            if (
              ...
              (cursor.scrollLeft < maxScrollLeft &&
                deltaX > 0)
            ) {
              return true;
            }
    ...
    function mousewheelHandler(e) {
      ...
      if (
        shouldBeConsumedByChild(e.target, deltaX, deltaY)
      ) {
        return;
      }
  ...
  var PerfectScrollbar = function PerfectScrollbar(
    ...
    this.railXMarginWidth =
      toInt(railXStyle.marginLeft) +
      toInt(railXStyle.marginRight);
    ...
    this.railYMarginHeight =
      toInt(railYStyle.marginTop) +
      toInt(railYStyle.marginBottom);
  ...
  PerfectScrollbar.prototype.removePsClasses =
    function removePsClasses() {
