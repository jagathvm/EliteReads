...
(function ($, window, document, undefined) {
  var ElevateZoom = {
    init: function (options, elem) {
      ...
      $('#' + self.options.gallery + ' a').click(function (
        e
      ) {
    ...
    startZoom: function () {
      ...
      if (self.options.zoomType == 'window') {
        ...
        if (
          self.largeWidth < self.options.zoomWindowWidth
        ) {
      ...
      if (self.options.zoomType != 'inner') {
        ...
        if (self.options.tint) {
          ...
          self.zoomTintcss = self.zoomLens.after(
            self.zoomTint
          );
      ...
      if (self.options.minZoomLevel) {
        ...
        self.minZoomLevel =
          self.options.scrollZoomIncrement * 2;
      }
    ...
    setPosition: function (e) {
      ...
      if (self.options.zoomType == 'window') {
        ...
        self.Eloppos =
          self.mouseLeft < 0 + self.zoomLens.width() / 2;
        self.Eroppos =
          self.mouseLeft >
          self.nzWidth -
      ...
      if (self.options.zoomType == 'inner') {
        self.Etoppos =
          self.mouseTop <
          self.nzHeight / 2 / self.heightRatio;
        self.Eboppos =
          self.mouseTop >
          self.nzHeight -
            self.nzHeight / 2 / self.heightRatio;
        self.Eloppos =
          self.mouseLeft <
          0 + self.nzWidth / 2 / self.widthRatio;
        self.Eroppos =
          self.mouseLeft >
          self.nzWidth -
    ...
    setWindowPostition: function (e) {
      ...
      if (!isNaN(self.options.zoomWindowPosition)) {
        switch (self.options.zoomWindowPosition) {
          case 1: //done
            self.windowOffsetTop =
              self.options.zoomWindowOffety; //DONE - 1
        ...
        self.externalContainerWidth =
          self.externalContainer.width();
        self.externalContainerHeight =
          self.externalContainer.height();
        self.externalContainerOffset =
          self.externalContainer.offset();

        self.windowOffsetTop =
          self.externalContainerOffset.top; //DONE - 1
        self.windowOffsetLeft =
          self.externalContainerOffset.left; //DONE 1, 2, 3, 4, 16
      }
      ...
      if (
        ...
        if (self.options.zoomType == 'window') {
          if (
            self.largeHeight < self.options.zoomWindowHeight
          ) {
            self.windowTopPos = 0;
          }
          if (
    ...
    changeZoomLevel: function (value) {
      ...
      maxwidthtnewvalue =
        self.largeWidth /
        ((self.options.zoomWindowWidth / self.nzWidth) *
          self.nzWidth);
