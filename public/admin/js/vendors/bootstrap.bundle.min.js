...
!(function (t, e) {
  ...
  function I(t, e, n) {
    void 0 === n && (n = null);
    for (
      var i = Object.keys(t), o = 0, r = i.length;
      o < r;
      o++
    ) {
      var s = t[i[o]];
  ...
  var J = 'collapse',
    ...
    nt = (function (t) {
      function o(e, n) {
        var i;
        ((i = t.call(this, e) || this)._isTransitioning =
          !1),
          (i._config = i._getConfig(n)),
  ...
  function ht(t) {
    return (
      t instanceof dt(t).Element || t instanceof Element
    );
  }
  function pt(t) {
    return (
      t instanceof dt(t).HTMLElement ||
  ...
  function _t(t, e) {
    ...
    if (
      i &&
      ((n = i) instanceof dt(n).ShadowRoot ||
  ...
  function wt(t) {
    return (
      (ht(t) ? t.ownerDocument : t.document) ||
      window.document
    ).documentElement;
  }
  function Et(t) {
  ...
  var Dt = {
      ...
      fn: function (t) {
        ...
        if (o && r) {
          var c =
              n.modifiersData[i + '#persistent'].padding,
            u = vt(o),
            f = 'y' === a ? it : st,
            d = 'y' === a ? ot : rt,
            h =
  ...
  function Ut(t, e) {
    ...
    var n = (function t(e) {
      ...
      o = dt(n),
      r = i
        ? [o].concat(o.visualViewport || [], Qt(n) ? n : [])
        : n,
      s = e.concat(r);
    ...
    if (null != c) {
      ...
      switch (s) {
        case 'start':
          e[c] =
            Math.floor(e[c]) -
            Math.floor(n[u] / 2 - i[u] / 2);
          break;
        case 'end':
          e[c] =
            Math.floor(e[c]) +
            Math.ceil(n[u] / 2 - i[u] / 2);
      }
    }
    return e;
  }
  function Xt(t, e) {
    ...
    var n = e,
      ...
      y = qt(
        ht(b)
          ? b
          : b.contextElement || wt(t.elements.popper),
        s,
        l
      ),
      w = Rt(v),
      ...
      return (
        ...
        (r.hide = function () {
          if (
            ...
            var t = o.getParentFromElement(this._element),
              e = { relatedTarget: this._element };
            H.trigger(t, 'hide.bs.dropdown', e)
              .defaultPrevented ||
