...
!(function (t, e) {
  ...
  function i(t, e) {
    ...
    return function () {
      return (
        e ? (clearTimeout(i), (i = setTimeout(t, e))) : t(),
        e
      );
    };
  }
  ...
  function S(t, e, i, n) {
    return (
      Array.isArray(e) ? t(e[0], e[1], e[2]) : t(e, i, n)
    ).map(m);
  }
  function P(t, e, i) {
    return S(v, t, e, i);
  ...
  function N(t) {
    return B(t)
      ? t
      : V(t).saturate(0.5).darken(0.1).hexString();
  }
  function H() {}
  const j = (function () {
    let t = 0;
  ...
  function J(t, e, i, n) {
    ...
    if (Y(t))
      ...
      for (
        a = Object.keys(t), s = a.length, o = 0;
        o < s;
        o++
      )
        e.call(i, t[a[o]], a[o]);
  ...
  function it(t) {
    return (
      -1 ===
      ['__proto__', 'prototype', 'constructor'].indexOf(t)
    );
  }
  function nt(t, e, i, n) {
    if (!it(t)) return;
  ...
  function Ft(t, e) {
    ...
    return (
      s < -0.5 * xt && (s += bt), { angle: s, distance: o }
    );
  }
  function zt(t, e) {
    return Math.sqrt(
  ...
  function Fe(t, e) {
    ...
    n &&
      !('' + n).match(Ae) &&
      (console.warn(
        'Invalid font style specified: "' + n + '"'
      ),
      (n = ''));
    const o = {
  ...
  function Ne(t, e) {
    return t.filter(
      (t) => -1 === Be.indexOf(t.pos) && t.box.axis === e
    );
  }
  function He(t, e) {
    return t.sort((t, i) => {
  ...
  function Ye(t, e, i) {
    ...
    const s = Math.max(
        0,
        e.outerWidth - je(o, t, 'left', 'right')
      ),
      a = Math.max(
        0,
        e.outerHeight - je(o, t, 'top', 'bottom')
      ),
      r = s !== t.w,
      l = a !== t.h;
    return (
  ...
  var Ke = {
    ...
    update(t, e, i, n) {
      ...
      const o = Ie(t.options.layout.padding),
        ...
        c = r.horizontal;
      J(t.boxes, (t) => {
        'function' == typeof t.beforeLayout &&
          t.beforeLayout();
      });
      const h =
          l.reduce(
      ...
      !(function (t, e) {
        ...
        for (i = 0, n = t.length; i < n; ++i)
          (o = t[i]),
            o.horizontal
              ? ((o.width =
                  o.box.fullSize && e.availableWidth),
                (o.height = e.hBoxMaxHeight))
              : ((o.width = e.vBoxMaxWidth),
                (o.height =
                  o.box.fullSize && e.availableHeight));
      })(l.concat(c), d),
        Xe(r.fullSize, f, d),
        Xe(l, f, d),
        Xe(c, f, d) && Xe(l, f, d),
  ...
  class Ze extends Ge {
    acquireContext(t) {
      return (
        (t && t.getContext && t.getContext('2d')) || null
      );
    }
  }
  const Qe = {
  ...
  function ii(t, e, i) {
    ...
    return (
      s.observe(document, { childList: !0, subtree: !0 }), s
    );
  }
  function ni(t, e, i) {
    const n = t.canvas,
  ...
  class hi extends Ge {
    ...
    removeEventListener(t, e) {
      const i = t.$proxies || (t.$proxies = {}),
        n = i[e];
      if (!n) return;
      (({ attach: li, detach: li, resize: li })[e] || ei)(
        t,
        e,
        n
      ),
  ...
  const ui = (t) => 0 === t || 1 === t,
      ...
      Math.sin(((t - e) * bt) / i),
    gi = (t, e, i) =>
      Math.pow(2, -10 * t) * Math.sin(((t - e) * bt) / i) +
      1,
    pi = {
      linear: (t) => t,
      easeInQuad: (t) => t * t,
  ...
  class bi {
    constructor(t, e, i, n) {
      ...
      (this._active = !0),
        ...
        (this._start = Math.floor(
          Date.now() + (t.delay || 0)
        )),
        (this._duration = this._total =
    ...
    update(t, e, i) {
      ...
      if (n._active) {
        ...
        const o = n._target[n._prop],
          ...
          a = n._duration - s;
        (n._start = i),
          (n._duration = Math.floor(
            Math.max(a, t.duration)
          )),
          (n._total += s),
          (n._loop = !!t.loop),
  ...
  class yi {
    ...
    configure(t) {
      ...
      Object.getOwnPropertyNames(t).forEach((i) => {
        ...
        ((Y(n.properties) && n.properties) || [i]).forEach(
          (t) => {
  ...
  class Ti {
    ...
    updateRangeFromParsed(t, e, i, n) {
      ...
      n &&
        ...
        (s = Mi(n, o, this._cachedMeta.index, {
          all: !0,
        }))),
        (t.min = Math.min(t.min, s)),
        (t.max = Math.max(t.max, s));
    ...
    getMinMax(t, e) {
      ...
      for (
        u = 0;
        u < a &&
        (m() || (i.updateRangeFromParsed(c, t, g, l), !s));
        ++u
      );
      if (s)
        for (u = a - 1; u >= 0; --u)
    ...
    _resolveAnimations(t, e, i) {
      ...
      return (
        l && l._cacheable && (s[a] = Object.freeze(c)), c
      );
    }
    getSharedOptions(t) {
      if (t.$shared)
  ...
  function Ei(t, e, i) {
    return (function (t, e) {
      ...
      return (
        n ||
          ((n = new Intl.NumberFormat(t, e)), Li.set(i, n)),
        n
      );
    })(e, i).format(t);
  }
  ...
  function zi(t, e) {
    ...
    if (s > 0) {
      let t, i;
      const n =
        s > 1 ? Math.round((r - a) / (s - 1)) : null;
      for (
        Vi(e, l, c, $(n) ? 0 : a - n, a), t = 0, i = s - 1;
        t < i;
        t++
      )
        Vi(e, l, c, o[t], o[t + 1]);
  ...
  function Vi(t, e, i, n, o) {
    ...
    for (l = Math.max(s, 0); l < a; l++)
      l === c &&
        (e.push(t[l]), h++, (c = Math.round(s + h * i)));
  }
  mt.set('scale', {
    display: !0,
    offset: !1,
  ...
  function ji(t, e) {
    ...
    const i = Fe(t.font, e),
      n = Ie(t.padding);
    return (
      (Y(t.text) ? t.text.length : 1) * i.lineHeight +
      n.height
    );
  }
  function $i(t, e, i) {
  ...
  class Yi extends Ri {
      ...
      (a = e.offset ? t.maxWidth / n : f / (n - 1)),
        d + 6 > a &&
          ...
          (c = Et(
            Math.min(
              Math.asin(
                Math.min((h.highest.height + 6) / a, 1)
              ),
              Math.asin(Math.min(r / l, 1)) -
                Math.asin(u / l)
            )
          )),
    ...
    _calculatePadding(t, e, i, n) {
      ...
      if (o.isHorizontal()) {
        const r = o.getPixelForTick(0) - o.left,
          h =
            o.right - o.getPixelForTick(o.ticks.length - 1);
        let d = 0,
          u = 0;
        l
          ? c
    ...
    _handleMargins() {
      const t = this;
      t._margins &&
        ((t._margins.left = Math.max(
          t.paddingLeft,
          t._margins.left
        )),
        (t._margins.top = Math.max(
          t.paddingTop,
          t._margins.top
        )),
        (t._margins.right = Math.max(
          t.paddingRight,
          t._margins.right
        )),
    ...
    _getLabelSizes() {
      ...
      if (!e) {
        ...
        i < n.length && (n = Wi(n, i)),
          (t._labelSizes = e =
            t._computeLabelSizes(n, n.length));
      }
      return e;
    }
    ...
    drawLabels(t) {
      ...
      const o =
        e._labelItems ||
        (e._labelItems = e._computeLabelItems(t));
      let s, a;
    ...
    drawTitle() {
      ...
      'bottom' === e
        ? ((l += a.bottom),
          Y(i.text) &&
            (l += s.lineHeight * (i.text.length - 1)))
        : (l += a.top);
      const {
        titleX: c,
        titleY: h,
    ...
    _resolveTickFontOptions(t) {
      return Fe(
        this.options.ticks.setContext(this.getContext(t))
          .font
      );
    }
  }
  ...
  function wn(t, e) {
    ...
    if (!0 === n)
      return Mn([{ start: a, end: r, loop: s }], i, e);
    return Mn(
      (function (t, e, i, n) {
        const o = t.length,
          s = [];
        ...
        return (
          null !== r &&
            s.push({ start: e % o, end: r % o, loop: n }),
          s
        );
      })(
        i,
  ...
  class Zn {
    ...
    _resize(t, e) {
      const i = this,
        ...
        l =
          n.devicePixelRatio ||
          i.platform.getDevicePixelRatio();
      (i.width === a.width &&
        i.height === a.height &&
        r === l) ||
        ((i.width = a.width),
    ...
    update(t) {
      ...
      let s = 0;
      for (
        let t = 0, i = e.data.datasets.length;
        t < i;
        t++
      ) {
    ...
    _updateLayout(t) {
      ...
      if (
        !1 ===
        e.notifyPlugins('beforeLayout', { cancelable: !0 })
      )
        return;
    ...
    _updateDatasets(t) {
      ...
      if (
        ...
        for (
          let n = 0, o = e.data.datasets.length;
          n < o;
          ++n
        )
          e._updateDataset(
            n,
            i ? t({ datasetIndex: n }) : t
          );
    ...
    draw() {
      ...
      if (
        !1 ===
        t.notifyPlugins('beforeDraw', { cancelable: !0 })
      )
        return;
      const i = t._layers;
    ...
    _drawDatasets() {
      ...
      if (
        !1 ===
        t.notifyPlugins('beforeDatasetsDraw', {
          cancelable: !0,
        })
      )
        return;
    ...
    _drawDataset(t) {
      ...
      !1 !== e.notifyPlugins('beforeDatasetDraw', s) &&
        (Gt(i, {
          ...
          right:
            !1 === n.right ? e.width : o.right + n.right,
    ...
    bindEvents() {
      const t = this,
        ...
        o = (n, o) => {
          e[n] &&
            (i.removeEventListener(t, n, o), delete e[n]);
        };
    ...
    updateHoverStyle(t, e, i) {
      ...
      for (
        ...
        const e =
          s &&
          this.getDatasetMeta(s.datasetIndex).controller;
        e &&
          e[n + 'HoverStyle'](
            s.element,
            s.datasetIndex,
    ...
    setActiveElements(t) {
      ...
      !tt(n, i) &&
        ((e._active = n), e._updateHoverStyles(n, i));
    }
    notifyPlugins(t, e, i) {
    ...
    _eventHandler(t, e) {
      const i = this,
        ...
        o = (e) =>
          (
            e.options.events || this.options.events
          ).includes(t.type);
    ...
    _handleEvent(t, e) {
      ...
      return (
        ...
        (l = !tt(r, n)),
        (l || e) &&
          ((i._active = r), i._updateHoverStyles(r, n, e)),
        (i._lastEvent = c),
        l
      );
    }
  ...
  const Qn = () =>
      J(Zn.instances, (t) => t._plugins.invalidate()),
    Jn = !0;
  function to() {
    throw new Error(
    ...
    const e = (function (t) {
      if (!t._cache.$bar) {
        ...
        for (let n = 0, o = e.length; n < o; n++)
          i = i.concat(
            e[n].controller.getAllParsedValues(t)
          );
  ...
  function ao(t) {
    return (
      t && void 0 !== t.barStart && void 0 !== t.barEnd
    );
  }
  class ro extends Ti {
    parsePrimitiveData(t, e, i, n) {
    ...
    updateElements(t, e, i, n) {
      ...
      for (let h = e; h < e + i; h++) {
        ...
        u &&
          (g.options =
            d || o.resolveDataElementOptions(h, n)),
    ...
    _getRuler() {
      ...
      for (s = 0, a = i.data.length; s < a; ++s)
        o.push(
          n.getPixelForValue(t.getParsed(s)[n.axis], s)
        );
      ...
      return {
        ...
        ratio: r
          ? 1
          : e.categoryPercentage * e.barPercentage,
      };
    }
      ...
      for (let l = e; l < e + i; l++) {
        const e = t[l],
          ...
          c = s
            ...
            : a.getPixelForValue(i.x),
          d = s
            ? r.getBasePixel()
            : r.getPixelForValue(i.y),
  ...
  class co extends Ti {
    ...
    update(t) {
      ...
      (e.offsetX = g * _),
        ...
        (e.outerRadius =
          _ - y * e._getRingWeightOffset(e.index)),
    ...
    updateElements(t, e, i, n) {
      ...
      for (x = e; x < e + i; ++x) {
        ...
        m &&
          (a.options =
            p || o.resolveDataElementOptions(x, n)),
          (b += e),
    ...
    _getRingWeight(t) {
      return Math.max(
        K(this.chart.data.datasets[t].weight, 1),
        0
      );
    }
  ...
  class ho extends Ti {
            ...
            (s = u
              ? Nt(
                  Math.max(
                    ...
                    i
                      ? 0
                      : ne(e, l, a.getPixelForValue(h)).hi +
                          1
                  ),
                  o,
                  n
    ...
    updateElements(t, e, i, n) {
      const o = this,
        ...
        g =
          o.chart._animationsDisabled || s || 'none' === n;
      ...
      for (let c = e; c < e + i; ++c) {
        ...
        (u.skip = isNaN(x) || isNaN(b) || m),
          ...
          d &&
            (u.options =
              h || o.resolveDataElementOptions(c, n)),
  ...
  function Do(t, e, i, n) {
    ...
    for (
      l && ((d = o[b(0)]), t.moveTo(d.x, d.y)), h = 0;
      h <= r;
      ++h
    ) {
  ...
  class To extends Ri {
    ...
    draw(t, e, i, n) {
      ...
      (o.points || []).length &&
        ...
        t.restore(),
        o.animated &&
          ((o._pointsUpdated = !1), (o._path = void 0)));
    }
  }
  function Ro(t, e, i, n) {
    const o = t.options,
    ...
    return {
      ...
      inner: {
        ...
        radius: {
          topLeft: Math.max(
            0,
            s.topLeft - Math.max(o.t, o.l)
          ),
          topRight: Math.max(
            0,
            s.topRight - Math.max(o.t, o.r)
          ),
          bottomLeft: Math.max(
            0,
            s.bottomLeft - Math.max(o.b, o.l)
          ),
  ...
  function Xo(t, e, i) {
    ...
    return X(o) && Math.floor(o) === o
      ? (('-' !== n[0] && '+' !== n[0]) || (o = e + o),
        !(o === e || o < 0 || o >= i) && o)
      : ['origin', 'start', 'end', 'stack'].indexOf(n) >=
          0 && n;
  }
  class qo {
    constructor(t) {
  ...
  function ss(t, e, i) {
    ...
    'x' === s &&
      (t.beginPath(), t.rect(a, n, r - a, o - n), t.clip());
  }
  function as(t, e, i, n) {
  ...
  class ds extends Ri {
    ...
    buildLabels() {
      ...
      e.filter &&
        (i = i.filter((i) => e.filter(i, t.chart.data))),
        e.sort &&
          (i = i.sort((i, n) =>
            e.sort(i, n, t.chart.data)
          )),
    ...
    _draw() {
      ...
      t.legendItems.forEach((e, M) => {
        ...
        const k = a.measureText(e.text).width,
          S = h.textAlign(
            e.textAlign || (e.textAlign = l.textAlign)
          ),
          P = x + g / 2 + k;
        let D = m.x,
          C = m.y;
  ...
  class fs extends Ri {
    ...
    update(t, e) {
      ...
      const s =
        o * Fe(n.font).lineHeight + i._padding.height;
  ...
  class Ps extends Ri {
    ...
    _resolveAnimations() {
      ...
      const i = t._chart,
        ...
        o =
          n.enabled && i.options.animation && n.animations,
        s = new yi(t._chart, o);
      return (
        o._cacheable &&
          (t._cachedAnimations = Object.freeze(s)),
        s
      );
    }
    getContext() {
    ...
    _createItems(t) {
      ...
      for (r = 0, l = i.length; r < l; ++r)
        c.push(bs(e._chart, i[r]));
      return (
        t.filter &&
          (c = c.filter((e, i, o) => t.filter(e, i, o, n))),
        t.itemSort &&
          (c = c.sort((e, i) => t.itemSort(e, i, n))),
        J(c, (i) => {
    ...
    handleEvent(t, e) {
      ...
      let s = !1,
        a = [];
      'mouseout' !== t.type &&
        ((a = i._chart.getElementsAtEventForMode(
          t,
          n.mode,
          n,
          e
  ...
  var Ds = {
      ...
      afterInit(t, e, i) {
        i &&
          (t.tooltip = new Ps({ _chart: t, options: i }));
      },
      beforeUpdate(t, e, i) {
  ...
  class As extends Yi {
    ...
    configure() {
      ...
      super.configure(),
        t.isHorizontal() ||
          (t._reversePixels = !t._reversePixels);
    }
    getPixelForValue(t) {
      const e = this;
      return (
    ...
    getValueForPixel(t) {
      ...
      return Math.round(
        e._startValue +
          e.getDecimalForPixel(t) * e._valueRange
      );
    }
    getBasePixel() {
      return this.bottom;
  ...
  (As.id = 'category'),
    (As.defaults = {
      ticks: { callback: As.prototype.getLabelForValue },
    });
  class Ts extends Yi {
    constructor(t) {
      super(t),
    ...
    buildTicks() {
      ...
      const o = (function (t, e) {
        ...
        for (
          ...
          (i.push({ value: o }),
          x <= o && v++,
          At(Math.round((x + v * y) * m) / m, o, y / 10) &&
            v++);
          v < _;
          ++v
        )
    ...
    configure() {
      ...
      let i = t.min,
        n = t.max;
      if (
        (super.configure(), t.options.offset && e.length)
      ) {
  ...
  (Rs.id = 'linear'),
    (Rs.defaults = {
      ticks: { callback: Fi.formatters.numeric },
    });
  class Es extends Yi {
    constructor(t) {
      super(t),
    ...
    getLabelForValue(t) {
      return void 0 === t
        ? '0'
        : Ei(t, this.chart.options.locale);
    }
    configure() {
      const t = this,
        e = t.min;
  ...
  function Is(t) {
    ...
    if (e.display && t.display) {
      ...
      return (
        K(e.font && e.font.size, mt.font.size) + t.height
      );
    }
    return 0;
  }
  ...
  class Ns extends Ts {
    ...
    setDimensions() {
      ...
      (t.width = t.maxWidth),
        ...
        (t.yCenter = Math.floor(
          (t.height - t.paddingTop) / 2
        )),
        (t.drawingArea =
    ...
    setCenterPoint(t, e, i, n) {
      ...
      (o.xCenter = Math.floor((a + s) / 2 + o.left)),
        (o.yCenter = Math.floor(
          (r + l) / 2 + o.top + o.paddingTop
        ));
    }
    getIndexAngle(t) {
      return Bt(
  ...
  class Ks extends Yi {
    ...
    determineDataLimits() {
      ...
      (a && r) ||
        (l(t._getLabelBounds()),
        ('ticks' === e.bounds &&
          'labels' === e.ticks.source) ||
          l(t.getMinMax(!1))),
        (o =
          X(o) && !isNaN(o)
            ? o
            : +i.startOf(Date.now(), n)),
        (s =
          X(s) && !isNaN(s)
            ? s
            : +i.endOf(Date.now(), n) + 1),
    ...
    initOffsets(t) {
      ...
      e.options.offset &&
        ...
        (s =
          1 === t.length
            ? n
            : (n - e.getDecimalForValue(t[t.length - 2])) /
              2));
    ...
    _generate() {
      const t = this,
        ...
        a =
          s.unit ||
          Us(s.minUnit, i, n, t._getLabelCapacity(i)),
        r = K(s.stepSize, 1),
      ...
      const g =
        'data' === o.ticks.source && t.getDataTimestamps();
      for (d = f, u = 0; d < n; d = +e.add(d, r, a), u++)
        Xs(h, d, g);
      return (
        (d !== n && 'ticks' !== o.bounds && 1 !== u) ||
          Xs(h, d, g),
        Object.keys(h)
          .sort((t, e) => t - e)
          .map((t) => +t)
    ...
    generateTickLabels(t) {
      ...
      for (e = 0, i = t.length; e < i; ++e)
        (n = t[e]),
          (n.label = this._tickFormatFunction(
            n.value,
            e,
            t
          ));
    ...
    _getLabelSize(t) {
      const e = this,
        ...
        o = Lt(
          e.isHorizontal() ? i.maxRotation : i.minRotation
        ),
        s = Math.cos(o),
        a = Math.sin(o),
    ...
    getDataTimestamps() {
      ...
      if (t._normalized && o.length)
        return (t._cache.data =
          o[0].controller.getAllParsedValues(t));
    ...
    getLabelTimestamps() {
      ...
      for (i = 0, n = o.length; i < n; ++i)
        e.push(Ys(t, o[i]));
      return (t._cache.labels = t._normalized
        ? e
        : t.normalize(e));
    }
    normalize(t) {
