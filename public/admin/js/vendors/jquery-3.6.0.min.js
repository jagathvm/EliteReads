...
!(function (e, t) {
  ...
  function (C, e) {
    ...
    (S.fn = S.prototype =
      ...
      S.extend({
        expando:
          'jQuery' + (f + Math.random()).replace(/\D/g, ''),
        isReady: !0,
        error: function (e) {
          throw new Error(e);
        },
    ...
    (ce = E.createDocumentFragment().appendChild(
      ...
      (fe = E.createElement('input')).setAttribute(
        'type',
        'radio'
      ),
      ...
      (y.noCloneChecked = !!ce.cloneNode(!0).lastChild
        .defaultValue),
      ...
      for (
        ...
        if ((o = e[d]) || 0 === o)
          if ('object' === w(o))
            ...
            (a =
              a || f.appendChild(t.createElement('div'))),
              (s = (de.exec(o) || [
                '',
                '',
              ])[1].toLowerCase()),
    ...
    function He(n, r, i, o) {
      ...
      if (
        f &&
        ((t = (e = xe(r, n[0].ownerDocument, !1, n, o))
          .firstChild),
        1 === e.childNodes.length && (e = t),
        t || o)
      ) {
        for (
          s = (a = S.map(ve(e, 'script'), De)).length;
          c < f;
          c++
        )
          (u = e),
    ...
    S.parseXML = function (e) {
      ...
      try {
        t = new C.DOMParser().parseFromString(
          e,
          'text/xml'
        );
      } catch (e) {}
      ...
      S.extend({
        ...
        ajax: function (e, t) {
          ...
          if (
            ...
            (v.type =
              t.method || t.type || v.method || v.type),
      ...
      S.fn.extend({
        ...
        position: function () {
          if (this[0]) {
            ...
            return {
              top:
                t.top - i.top - S.css(r, 'marginTop', !0),
              left:
                t.left -
                i.left -
